  ...
  Timepicker.prototype = {
    ...
    _init: function() {
      ...
      if (this.$element.parent().hasClass('input-group')) {
        this.$element.parent('.input-group').find('.input_timer').on({
    ...
    elementKeydown: function(e) {
		-1!==$.inArray(e.keyCode,[46,8,9,27,13,110,186,190])||/65|67|86|88/.test(e.keyCode)&&(!0===e.ctrlKey||!0===e.metaKey)||35<=e.keyCode&&40>=e.keyCode||(e.shiftKey||48>e.keyCode||57<e.keyCode)&&(96>e.keyCode||105<e.keyCode)&&e.preventDefault()
    ...
    updateColonElementVal: function() {
      var val = this.$element.val();
		val.replace(".", "");console.log('val',val);
      if (val) {
        this.setTime(val);
      }
    },
