...
if(count($request_url) == 3 && $request_url[0]=='out-system'){
	$st_login = 'out-system';
} else if(!empty($_SESSION) && isset($_SESSION['project_name']) && $_SESSION['project_name'] == _PROJECT_NAME_ && !empty($_SESSION['log_user'])){
...
switch ($st_login) {
	...
	case 'logout':
		...
		break;
	case 'home':
		require_once(_DIR_HOST_.'/controllers/Dashboard/HomeController.php');
		$controller = new HomeController;
