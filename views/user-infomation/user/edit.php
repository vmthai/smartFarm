              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group control-group">
                    ...
                    <input type="text" class="form-control border-info" placeholder="ตัวอย่าง นายสามารถ  ชาญชัย" name="name" value="<?=$data->name?>" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="projectinput1">Sex</label>
              ...
              <div class="row">               
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input type="text" id="email" class="form-control border-info" placeholder="E-mail" name="email" value="<?=$data->email?>">
                      </div>
                      <div class="form-group">
                          <label for="projectinput4">Contact Number</label>
                          <input type="text" class="form-control border-info" placeholder="เบอร์โทรศัพท์" name="phone" value="<?=$data->phone?>">
                      </div>
                      <div class="form-group">
                          <label for="projectinput4">Birth Date</label>
                          <input class="form-control border-info" type="text" placeholder="dd/mm/YY" data-provide="datepicker" data-date-language="th-th" data-date-autoclose="true" name="birth_date" value="<?=$data->birth_date_th?>">
                      </div>
                  </div>   
                  <?php
                  ...
                  <div class="row col-md-6">
                      <div class="col-md-12">
                          <div class="fileupload fileupload-new" data-provides="fileupload">
                              ...
                              <a href="#" class="btn btn-default fileupload-exists" data-dismiss="fileupload">Remove</a></div>
              ...
              <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group control-group">
                      ...
                      <option value="<?=$k?>" <?=($data->admin_roll_id==$k)?'selected':'';?>><?=$v?></option>
                          <?php  } ?>
                      </select>                                         
                    </div>
                  </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group control-group">
                      ...
                      <input type="text" id="Username" class="form-control border-primary" placeholder="Username" name="username" value="<?=$data->username?>" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="pnew_password">New Password</label>
                    <input type="text" id="new_password" class="form-control border-primary" placeholder="New Password" name="new_password">
                  </div>
                </div>
              </div>
