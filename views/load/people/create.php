<form class="form-horizontal" id="frm-people" novalidate>
    ...
    <div class="row">
      <div class="col-md-7">
        <div class="form-group control-group">
          <label for="people_name">ชื่อ - สกุล</label>
          <input type="text" class="form-control border-info" placeholder="Full Name" name="p_name" required>
        </div>
        <div class="form-group">
            <label for="farmer_pid">เลขที่บัตรประชาชน</label>
            <input type="text" id="id_card" class="form-control border-info format-idcard" placeholder="People ID" name="id_card" required>
        </div>
        <div class="form-group">
          <label for="phone">โทรศัพท์</label>
          <input type="text" id="phone" class="form-control border-info" placeholder="Phone No." name="phone" required>
        </div>
        <div class="form-group">
          <label for="email">E-Mail</label>
          <input type="text" id="email" class="form-control border-info" placeholder="E-mail" name="email" required>
        </div>
      </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="form-group">
          ...
          <input type="text" id="address_text" class="form-control border-primary" placeholder="Address" name="address_text">
      </div>
    </div>
  </div>
  <div class="row">
  ...
  <div class="heading">ส่งเอกสาร <input type="checkbox" class="form-checkbox" name="use_address" value="1" onclick="copyAddressPeople(this);"> ใช้ที่อยู่ตามบัตรประชาชน</div>
  <div class="row">
    <div class="col-md-12">
      <div class="form-group">
          <label for="contact_text">เลขที่</label>
          <input type="text" id="contact_text" class="form-control border-primary" placeholder="Address" name="contact_text">
      </div>
    </div>
  </div>
  <div class="row">
