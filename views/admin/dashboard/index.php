<script src="<?=_HTTP_HOST_?>/app-assets/vendors/js/charts/chart.min.js" type="text/javascript"></script>
<script src="<?=_HTTP_HOST_?>/app-assets/js/scripts/pages/dashboard-lite.js" type="text/javascript"></script>
