            ...
            <div class="form-body">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group control-group">
                    ...
                    <input type="text" class="form-control border-info" placeholder="ตัวอย่าง นายสามารถ  ชาญชัย" name="contact_name" value="<?=$data->contact_name?>" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div style="margin-top:5px;">
                      <label class="radio-inline">
                          <input type="radio" class="form-radio" name="contact_sex" value="F" <?=($data->contact_sex=='F')?'checked':''?>>
                           ชาย
                      </label>&nbsp;
                      <label class="radio-inline">
                          <input type="radio" class="form-radio" name="contact_sex" value="M" <?=($data->contact_sex=='M')?'checked':''?>>
                           หญิง
                      </label>  
                    </div>                                         
                  </div>
              ...
              <div class="row">         
                  <div class="col-md-6">
                      <div class="form-group control-group">
                          ...
                          <input type="email" id="contact_email" class="form-control border-info" placeholder="E-mail" name="contact_email" value="<?=$data->contact_email?>">
                      </div>
                      <div class="form-group">
                          <label for="phone">Contact Number</label>
                          <input type="text" class="form-control border-info" placeholder="เบอร์โทรศัพท์" name="contact_phone" value="<?=$data->contact_phone?>">
                      </div>
                      <div class="form-group">
                          <label for="projectinput4">Position</label>
                          <input type="text" class="form-control border-info" placeholder="ตำแหน่งในองค์กร" name="contact_position" value="<?=$data->contact_position?>">
                      </div>
                  </div>   
                  <?php
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group control-group">
                      ...
                      <input type="text" id="farmer_gname" class="form-control border-primary" placeholder="Groupname" name="farmer_gname" value="<?=$data->farmer_gname?>" required>
                  </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group control-group">
                        <label for="CompanyName">ชื่อบริษัทฯ</label>
                        <input type="text" id="companyName" class="form-control border-primary" placeholder="companyName" name="company_name" value="<?=$data->company_name?>" required>                                    
                    </div>
                </div>
              </div> 
              <div class="row">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group control-group">
                      ...
                      <input type="text" id="company_phone" class="form-control border-primary" placeholder="Phome" name="company_phone" value="<?=$data->company_phone?>" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group control-group">
                      <label for="emailAddress">Email</label>
                      <input type="email" id="company_email" class="form-control border-primary" placeholder="Email Address" name="company_email" value="<?=$data->company_email?>" required>                                    
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                      ...
                      <input type="text" id="address_text" class="form-control border-primary" placeholder="Address" name="address_text" value="<?=$data->address_text?>" required>
                  </div>
                </div>
              </div>
              <div class="row">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label>
                        <input type="checkbox" class="form-checkbox" name="use_address" value="1" onclick="copyAddressPeople(this);" <?=($data->use_address=="1")?'checked':''?>> ใช้ตามที่ตั้งบริษัทฯ
                    </label>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                      ...
                      <input type="text" id="contact_text" class="form-control border-primary" placeholder="Address" name="contact_text" value="<?=$data->contact_text?>" required>
                  </div>
                </div>
              </div>
              <div class="row">
