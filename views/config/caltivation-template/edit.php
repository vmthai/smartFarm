            ...
            <div class="form-body">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group control-group">
                    ...
                    <input type="text" class="form-control border-info" placeholder="Exp - สุพรรณบุรี 1" name="template_name" onblur="checkTrimData(this);" value="<?=$data->template_name;?>" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group control-group">
                    ...
                    <select class="form-control border-info" id="plant_type_id" name="plant_type_id" required>
                        ...
                        <?php  foreach($dataPlant as $k => $v){ ?>
                          <option value="<?=$k?>" <?=($data->plant_type_id == $k)?'selected':'';?>><?=$v?></option>
                        <?php  } ?>
                    </select>                                         
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <?php  foreach($dataSeed as $k => $v){ ?>
                    <option value="<?=$k?>" <?=($data->seed_type_id == $k)?'selected':'';?>><?=$v?></option>
                  <?php  } ?>
                  </select>
                  </div>
                </div>
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control border-info number" placeholder="ระยะเวลาการเพาะปลูก" name="culti_period" value="<?=$data->culti_period;?>" readonly required>                                   
                    </div>
                </div>
              </div> 
              <div class="row">
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control border-info number_decimal" placeholder="ผลผลิต / ไร่" name="yield" value="<?=$data->yield;?>">
                  </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group control-group">
                    <label for="cost">Cost / Rai</label>
                    <input type="text" class="form-control border-info number_decimal" placeholder="ต้นทุน / ไร่" name="cost" value="<?=$data->cost;?>" readonly>
                    </div>
                </div>
              </div> 
              <div class="row">
                <div class="col-md-6">
                  ...
                  <input type="checkbox" class="form-checkbox" name="active" value="1" <?=(!empty($data->active))?'checked':'';?>> 
                  </div>
                </div>
                <div class="col-md-6">
